...
Na terceira etapa o SR busca as informações necessárias para a recomendação, tanto sobre os itens acessados pelo usuário quanto
...
para gerar as recomendações e retorna para a Aplicação. A última etapa é responsabilidade da Aplicação, que prepara as
