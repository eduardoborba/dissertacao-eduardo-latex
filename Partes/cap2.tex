...
usuário não exclusivas de SR: \textit{Technology Acceptance Model} (TAM) e \textit{Software Usability Measurement
Inventory} (SUMI). O TAM consiste em três construtos: Facilidade de Uso Percebida, Utilidade Percebida e Intenções do
Usuário em utilizar o sistema. Enquanto o SUMI consiste de cinco construtos (Eficiência, Influência, Ajuda, Controle,
Capacidade de Aprendizado) e um questionário de 50 questões.
