...
Foram realizados experimentos com a base de dados WS-Dream comparando o algoritmo proposto com outros 6 algoritmos: RBA,
UPCC, IPCC, CASR, CASR-UP e ITRP-WS. A avaliação foi realizada utilizando uma estratégia \textit{offline} e as métricas utilizadas para a comparação foram
...
algoritmo proposto sem o uso do contexto (CAPS-C), um método de recomendação personalizado chamado pelos autores de Simple-P e um
