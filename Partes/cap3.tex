...
pelos autores de forma empírica, não tendo um método para a definição dessa constante. O trabalho de \citeonline{qiao2015personalized},
...
A proposta desse trabalho utiliza uma estratégia similar a de \citeonline{luo2010context}.

Sobre a avaliação, podemos observar que a maioria utiliza uma avaliação \textit{Offline}. \citeonline{bencic2012action} realiza
