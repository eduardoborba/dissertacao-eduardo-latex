...
considera o decaimento nos interesses do usuário com o passar do tempo (categoria do \textit{Decay}). Nesse capítulo é apresentado
...
O cálculo da similaridade será feito utilizando a técnica do Cosseno entre o perfil do usuário e todos os itens da disciplina
que podem ser recomendados. O cálculo da recência é realizado apenas para os itens do perfil do usuário que tem alguma similaridade com
determinado item candidato a recomendação. Nesse cálculo é considerada a posição do item na lista de acessos do usuário ordenada pelo tempo
