...
ao item candidato e é mais recente, para utilizar o seu valor de recência no cálculo do Escore.
...
\begin{algorithm}
  ...
  \algoritmoRecomendacaoDecay{$(Usuário)$}{
    ...
    \ForEach{$item \in itens$}{
      ...
      Escores[item] = similaridade * recência + item.acessado\;
    }

    \Return Escores.max(5)\;
  }
\end{algorithm}

O cálculo do Escore para o item candidato é finalmente realizado utilizando a Equação \ref{eq:relevancia-proposta}. Os cinco
itens com o maior Escore são retornados pelo algoritmo para serem recomendados ao usuário.
...
\begin{tabular}{|p{2cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
  ...
  \hline
  Escore final & $2.0$ & $1.0$ & $1.0$ & $1.0$ \\
  \hline
\end{tabular}
\legend{Fonte: O autor.}
\end{table}

Dessa forma, como podemos ver na tabela os itens relacionados a pilhas terão um maior Escore e serão os itens recomendados.
...
\begin{tabular}{|p{2cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
  ...
  Acessado ou não & $1.0$ & $1.0$ & $1.0$ & $1.0$ \\
  \hline
  Escore final & $1.245$ & $1.3$ & $1.0$ & $1.0$ \\
  \hline
\end{tabular}
\legend{Fonte: O autor.}
\end{table}

Podemos observar na tabela que, mesmo o perfil do usuário sendo ainda mais similar a itens com a palavra-chave "Pilha",
o impato da Recência no algoritmo fez com o escore final dos itens relacionados a filas seja maior e, dessa forma, esses
...
\begin{tabular}{|p{2cm}|p{3cm}|p{3cm}|p{3cm}|p{3cm}|}
  ...
  Acessado ou não & $1.0$ & $1.0$ & $1.0$ & $1.0$ \\
  \hline
  Escore final & $1.75$ & $1.175$ & $1.0$ & $1.0$ \\
  \hline
\end{tabular}
\legend{Fonte: O autor.}
\end{table}
