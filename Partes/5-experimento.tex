...
\begin{tabular}{ccccc}
  ...
  \multicolumn{2}{c}{\multirow{2}{*}{\textbf{Critério}}}           & \multirow{2}{*}{\textbf{Total}}           & \multicolumn{2}{c}{\textbf{Algoritmo de Recomendação}} \\
                                        &                          &                                           & AlgoritmoTradicional          & AlgoritmoProposta                        \\
  \hline
...
desempenho do algoritmo de recomendação e a percepção do usuário sobre a qualidade das recomendações. O desempenho do SR
...
\hline
                          & \textbf{AlgoritmoTradicional}                                           & \textbf{Frequência} \\
\hline
...
\hline
                          & \textbf{AlgoritmoProposta}                                              & \textbf{Frequência} \\
\hline
