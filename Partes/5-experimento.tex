...
que responderam à essa questão, 61 disseram não ter utilizado ou ter utilizado muito pouco o sistema de recomendação
e não citaram nenhum ponto positivo ou negativo, sendo 37 do grupo que utilizou a abordagem Baseada em Conteúdo Tradicional
e 24 que utilizaram a abordagem Com Decaimento. Um desses alunos que justifica dizendo que não encontrou o Sistema de Recomendação
no ambiente e outro dizendo que não entendeu como ele funcionava. Outro aluno ainda justificou dizendo que não utilizou
o Sistema de Recomendação pois achou que o conteúdo do Minicurso de Algoritmos era bem completo por si só.

Dos alunos que utilizaram a abordagem Tradicional e que responderam ter utilizado o SR, os principais comentários positivos foram:

\begin{itemize}
  \item ''O sistema lhe coloca conteúdo condizente ao seu nível.''
  \item ''Os materiais recomendados ajudaram a entender alguns assuntos pouco aprofundados.''
  \item ''O sistema atende às necessidades, recomendando sempre o que convém.''
  \item ''Ajudou bastante pois foi me passando um conhecimento sequencial.''
  \item ''Para guiar-me melhor.''
  \item ''Foi muito bem criado.''
  \item ''O sistema de recomendação esclareceu pontos do nosso interesse.''
  \item ''O layout do sistema é simples e intuitivo.''
  \item ''Achei muito interessante a sugestão conter vários artigos e também slides sobre o conteúdo, sobretudo, ter a possiblidade de fazer download dos arquivos foi a melhor parte.''
\end{itemize}

Dos alunos que utilizaram a abordagem Tradicional e que responderam ter utilizado o SR, os principais comentários negativos foram:

\begin{itemize}
  \item ''Após um tempo não recebia mais recomendações novas.''
  \item ''Se repete demais em muitos conceitos. Dá a mesma informação, porém com palavras e exemplos diferentes. Acaba se repetindo demais, enquanto poderia estar mostrando conteúdos novos.''
\end{itemize}

Dos alunos que utilizaram a Proposta desse trabalho e que responderam ter utilizado o SR, os principais comentários positivos foram:

\begin{itemize}
  \item ''Dá mais suporte pro aluno.''
  \item ''As recomendações feitas pelo minicurso são muito boas.''
  \item ''Facilidade de encontrar itens para estudo.''
  \item ''Muitos dos links continham conteúdos muito bons e relevantes.''
  \item ''Achei adequado ao andamento da disciplina e às minhas dúvidas.''
  \item ''As minhas recomendações eram condizentes ao conteúdo que iria ver.''
  \item ''Auxilia no desempenho e interesse do aluno.''
  \item ''Considerei de maneira muito positiva pois ajuda em uma melhor e mais eficiente construção do conhecimento, uma vez que conhecimentos bem dominados não precisam ser repetidos e conhecimentos 'pouco dominados' são mais bem explorados.''
  \item ''Nas vezes em que eu o utilizei o mesmo sempre trouxe sugestões apropriadas sem nenhum erro.''
  \item ''Achei interessante a parte de direcionamento e incentivo ao aprendizado.''
\end{itemize}

Dos alunos que utilizaram a Proposta desse trabalho e que responderam ter utilizado o SR, os principais comentários negativos foram:

\begin{itemize}
  \item ''Talvez eles pudessem se renovar mais a cada conteúdo.''
  \item ''Itens que eu não tinha interesse apareceram repetidas vezes.''
  \item ''Não achei ele necessário, visto que bastava fazer uma busca no Google para encontrar algumas respostas ou buscar aprofundamentos.''
\end{itemize}

Pela questão aberta é possível perceber que alunos de ambos os grupos gostaram do Sistema de Recomendação e consideram que
esse tipo de sistema auxilia nos seus estudos. Porém, também pode-se perceber que alguns alunos de ambos os grupos
perceberam que os itens recomendados se repetiam muito e poderiam ser mais diversificados. Por essa questão, não foi possível
perceber qual dos algoritmos teve um resultado melhor.
...
foi chegado ao resultado que proposta desse trabalho apresentou melhor resultado apenas na questão 12, na qual dizia
