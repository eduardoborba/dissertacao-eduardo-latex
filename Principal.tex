...
\titulo{ANÁLISE DA INFLUÊNCIA NO DESEMPENHO E PERCEPÇÃO DOS ALUNOS DE UM SISTEMA DE RECOMENDAÇÃO QUE CONSIDERA A VARIAÇÃO TEMPORAL DOS INTERESSES DO USUÁRIO NO CONTEXTO EDUCACIONAL}
...
\begin{apendicesenv}
  ...
  \include{Partes/apeF-palavras-materiais}
  \include{Partes/apeG-intervencoes}
  \include{Partes/apeH-analise-questionario}
  \include{Partes/apeI-analise-uso}
\end{apendicesenv}
