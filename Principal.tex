...
\titulo{UM SISTEMA DE RECOMENDAÇÃO PARA AMBIENTES VIRTUAIS DE APRENDIZAGEM QUE CONSIDERA A VARIAÇÃO TEMPORAL DOS INTERESSES DOS ALUNOS: CONCEPÇÃO, EXPERIMENTO E AVALIAÇÃO}
...
\include{Partes/1-introducao}
\include{Partes/2-fundamentacao}
\include{Partes/3-trabalhos-relacionados}
\include{Partes/4-sr-sensivel-ao-tempo}
\include{Partes/5-experimento}
\include{Partes/6-conclusao}
...
\begin{apendicesenv}
  ...
  \include{Partes/apeA-dicionario}
  \include{Partes/apeB-palavras-materiais}
  \include{Partes/apeC-tcle}
  \include{Partes/apeD-questionario}
  \include{Partes/apeE-teste-piloto}
  \include{Partes/apeF-analise-uso}
  \include{Partes/apeG-analise-questionario}
\end{apendicesenv}
...
\begin{anexosenv}
  ...
  \include{Partes/aneA-questoes}
  \include{Partes/aneB-intervencoes}
  \include{Partes/aneC-desafios}
\end{anexosenv}
